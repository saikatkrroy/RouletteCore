...
namespace Roulette.Security.Services
{
    ...
    {
        IRepository<Users> _usersRepository { get; set; }
        ...
        public AccountServices(/*IRepository<Users> usersRepository,
                                IRepository<UserSessions> userSessionRepository,
                                IRepository<UserSessionLog> userSessionLogRepository,
                                IRepository<Logs> logRepository, IUnitOfWork unitOfWork*/)
        {
